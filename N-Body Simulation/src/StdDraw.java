...
public final class StdDraw implements ActionListener, MouseListener, MouseMotionListener, KeyListener {
	...
	private static JMenuBar createMenuBar() {
		...
		JMenuItem pattern11 = new JMenuItem("Chaos Blossom");
	 ...
	 * number of shapes (call <tt>show(0)</tt> to defer drawing on screen, draw
	 * the shapes, and call <tt>show(0)</tt> to display them all on screen at
	 * once).
	 * 
	 * @param t
